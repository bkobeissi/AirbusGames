...
{
    public Transform BG1, BG2; //Deux fonds collés 
    public float scrollSpeed; // vitesse de défilement

    private float bgWidth; //largeur de notre fond
    ...
    void Update() //boucle de défilement
    {
